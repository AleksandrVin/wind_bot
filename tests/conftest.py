...
def sample_weather_data() -> WeatherData:
    ...
    return WeatherData(
        ...
        pressure=1012,
        humidity=65,
        wind=WindSpeed(speed_ms=5.2, gust_ms=7.8),
        clouds=25,
        rain_1h=None,
        rain_3h=None,
        snow_1h=None,
        snow_3h=None,
        weather_conditions=[WeatherCondition(id=800, main="Clear", description="clear sky", icon="01d")],
...
def sample_weather_response() -> Dict[str, Any]:
    ...
    return {
        ...
        "visibility": 10000,
        "wind": {"speed": 5.2, "deg": 120, "gust": 7.8},
        "clouds": {"all": 25},
